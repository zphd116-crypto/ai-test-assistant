...
**恭喜你，环境已全部就绪。** 输入 `quit` 退出程序，等课堂上讲师带你操作即可。

> ⚠️ **请不要提前尝试补全 tools.py / schemas.py** —— 这是课堂上讲师带着做的核心练习环节。
>
> 如果你好奇输入了"帮我执行 TC001"看到报错 `NotImplementedError`，这是**正常的** —— 说明工具还没实现，课上你会亲手写完它。

---

以下是**课堂上**的内容（课前无需阅读，开课时讲师会逐步引导）：
